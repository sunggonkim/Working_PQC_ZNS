...
\begin{figure*}[t]
\centering
\includegraphics[width=0.62\textwidth]{../artifacts/figures/paper/epoch-upper-bound.pdf}
...
\begin{figure*}[t]
\centering
\subfloat[GC caused by mixed PQC cohorts.]{
\includegraphics[width=0.48\textwidth]{../artifacts/figures/fast-style/fig2-pressure-breadth-gc.pdf}
}
\hfill
\subfloat[Expired PQC secrets stranded after epoch close.]{
\includegraphics[width=0.48\textwidth]{../artifacts/figures/fast-style/fig2-pressure-breadth-secrets.pdf}
}
\caption{PQC lifecycle pressure breadth.  The x-axis names the service carrier, but the measured failure is PQC-specific: expired secret cohorts remain mixed with live payload under history-based placement.  \system-\dogi keeps those cohorts reset-eligible while preserving payload placement on the history fallback.}
