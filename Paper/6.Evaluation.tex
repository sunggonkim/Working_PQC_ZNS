...
The artifact manifest records 40 evidence artifacts, their roles, abbreviated hashes, and regeneration commands.  Validation finds zero hash mismatches, and the local acceptance report passes 41 of 41 gates.  These checks make the scoped evidence auditable.
